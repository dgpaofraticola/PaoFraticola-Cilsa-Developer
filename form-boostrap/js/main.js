...
//aca estoy validando el nombre y apellido que no coloquen numeros solo letras =)) me faltaba esto
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    nombreInput.addEventListener('input', function() {
      validateInput(nombreInput, nombreError);
    });
  
    apellidoInput.addEventListener('input', function() {
      validateInput(apellidoInput, apellidoError);
    });
  });
